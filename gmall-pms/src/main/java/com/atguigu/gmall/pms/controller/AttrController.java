...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryAttrsByCid(@PathVariable("cid") Long cid,
        ...
        List<AttrEntity> attrEntitys = this.attrService.queryAttrsByCid(cid,type,searchType);
    ...
    public ResponseVo<List<AttrEntity>> queryGroupById(@PathVariable("gid") Long gid){
