...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuByCidAndPage(@PathVariable("categoryId") Long categoryId,
                                                    PageParamVo pageParamVo){
       PageResultVo pageResultVo = this.spuService.querySpuByCidAndPage(categoryId,pageParamVo);
        return ResponseVo.ok(pageResultVo);
    }

    @PostMapping("json")
    @ApiOperation("分页查询 search")
    //当前页的数据集合
