...
public class UserAddressController {
    ...
    public ResponseVo<List<UserAddressEntity>> queryAddressesByUserId(@RequestParam("userId")Long userId){
        List<UserAddressEntity> addressEntity = this.userAddressService.list(new QueryWrapper<UserAddressEntity>().eq("user_id", userId));
        return ResponseVo.ok(addressEntity);
    }
    /**
     * 列表
     */
